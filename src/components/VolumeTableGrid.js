...
export default function VolumeDataTable() {
  ...
  const rows = data
    ? data.map((k, v) => ({
        ...
        ce_volume: k[1]["ce_volume"],
        pe_volume: k[1]["pe_volume"],
        diff: k[1]["difference"],
        view: k[1]["view"],
        vdiff: k[1]["v_diff"],
        adiff: k[1]["avg_diff"] ? k[1]["avg_diff"].toFixed(2) : 0,
        wva: k[1]["wva"] ? k[1]["wva"].toFixed(2) : 0,
        pcr: k[1]["pcr"] ? k[1]["pcr"].toFixed(2) : 0,
      }))
    : [];
  const columns = [
    {
